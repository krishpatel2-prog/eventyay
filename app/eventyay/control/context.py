...
from eventyay.control.navigation import (
...
def contextprocessor(request):
    ...
    """
    if not hasattr(request, '_eventyay_control_default_context'):
        request._eventyay_control_default_context = _default_context(request)
    return request._eventyay_control_default_context
